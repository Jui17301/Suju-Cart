          ...
          <div className="flex flex-wrap md:flex-nowrap gap-4">
            <div className="w-full">
              <Select
                ...
                className="dark:text-white"
              >
                <SelectItem key="1">Bedroom</SelectItem>
                <SelectItem key="2">Dining Room</SelectItem>
                <SelectItem key="3">Living Room</SelectItem>
                <SelectItem key="4">Office Furniture</SelectItem>
              </Select>
              {errors.category && (
                <p className="text-red-500 dark:text-red-400 text-sm">
