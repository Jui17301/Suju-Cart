...
//   const { products, totalPrice, selectedItems } = useAppSelector(
//     (store) => store.cart
//   );
...
//   const [paymentIntentId, setPaymentIntentId] = useState<string | null>(null); // State to hold payment intent ID
...
//         "http://localhost:5000/api/bookings/payment-intent",
...
//         setPaymentIntentId(paymentIntent.id); // Store payment intent ID
...
//           {
//             ...order,
//             paymentIntentId: paymentIntent.id, // Add paymentIntentId to the booking
//           },
//           {
//             headers: {
//               Authorization: `Bearer ${token}`,
...
//             Pay: <span>${(totalPrice / 100).toFixed(2)}</span>
//           </h2>
...
//             {products.map(
//               (
//                 product: Product // Specify type for product
//               ) => (
//                 <li key={product._id}>
